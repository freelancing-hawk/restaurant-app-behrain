                ...
                <form action="<?php echo base_url()?>authentication/add_reservation" method="post" autocomplete="off" class="defaultForm add_reservation">
                    ...
                    <div class="reservation_form">
                        <div class="row">
                            ...
                            <?php else:?>
                                <input type="hidden" id="outlet_id" name="company_id" value="1">
                            <?php endif?>
                            <div class="form-group col-md-6 pr-5">
                                <label for="">Name <span class="error">*</span></label>
                                <input type="text" name="name" class="form-control required_checker">
                            </div>
                            <div class="form-group col-md-6 pl-5">
                                <label for="">Phone <span class="error">*</span></label>
                                <input type="text" name="phone" class="form-control required_checker">
                            </div>
                            ...
                            <div class="form-group col-md-6 pl-5">
                                ...
                                <input type="number" name="number_of_guest" class="form-control required_checker">
                            </div>

                            <div class="form-group col-md-6 pr-5">
                                <label for="">Reservation Date <span class="error">*</span></label>
                                <input type="text" name="reservation_date" id="reservation_date" placeholder="Select your date & time" class="form-control start_date_today"  readonly>
                            </div>
                            <div class="form-group col-md-6 pl-5">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="special_request" id="comments" class="form-control" cols="5" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
