                            ...
                            <table class="table">
                                ...
                                ?>
                                    <tr class="row_variation_view" id="row_variation_view1">
                                        ...
                                        <td>
                                            <input type="hidden" class="variation_row_update" value="<?php echo escape_output($value->id)?>" name="variation_row_update[]" id="variation_row_update1"><input type="hidden" class="variation_ingrs" value="<?php echo ($value->vr_ingr)?>" name="variation_ingrs[]" id="variation_ingrs1"><input type="hidden" value="<?php echo escape_output($value->name)?>" name="variation_name[]"><input type="hidden" value="<?php echo escape_output($value->sale_price)?>" name="m_sale_price[]"><input type="hidden" value="<?php echo escape_output($value->sale_price_take_away)?>" name="m_sale_price_take_away[]"><input type="hidden" value="<?php echo escape_output($value->sale_price_delivery)?>" name="m_sale_price_delivery[]"> <input type="hidden" value="<?php echo escape_output($value->loyalty_point)?>" name="vr01_loyalty_point_arr[]"> <input type="hidden" class="hidden_delivery_html" value="<?php echo escape_output($value->vr_del_details)?>" name="hidden_delivery_html[]" id="hidden_delivery_html"><input type="hidden" name="vr_tax_counter[]" value="1">
                                            <?php
                                                $collect_tax = $this->session->userdata('collect_tax');
                                                if(isset($collect_tax) && $collect_tax=="Yes"):
