                ...
                <div class="form-group">
                    ...
                    <select tabindex="2" class="form-control select2 ir_w_100" id="outlet_id" name="outlet_id">
                        ...
                        foreach ($outlets as $value):
                            ?>
                            <option  <?php echo isset($kitchen->outlet_id) && $kitchen->outlet_id==$value->id?'selected':''?> <?= set_select('outlet_id',$value->id)?>  value="<?php echo escape_output($value->id) ?>"><?php echo escape_output($value->outlet_name) ?></option>
                            <?php
                        endforeach;
                        ?>
                    </select>
