                     ...
                     <table id="datatable" class="table table-responsive">
                         <thead>
                             <tr>
                                 ...
                                 <th class="ir_w_11"><?php echo lang('transfer_type'); ?></th>
                                 ...
                                 <td class="ir_txt_center">
                                     <div class="btn-group  actionDropDownBtn">
                                         ...
                                         <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton1" role="menu">
                                             <li data-access="view_details-112" class="menu_assign_class"><a
                                             ...
                                             <?php
                                                if($prchs->status!=1):
                                             ?>
                                             <li data-access="update-112" class="menu_assign_class" ><a
                                                    ...
                                                    ?>
                                             <li data-access="delete-112" class="menu_assign_class"><a class="delete"
