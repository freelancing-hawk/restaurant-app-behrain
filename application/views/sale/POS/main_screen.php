...
foreach($tables as $table){
    $tables_modal .= '<div class="single_order_table area_all_table area_table_'.$table->area.'" data-table_name="'.$table->name.'"  data-area_name="'.getAreaName($table->area).'" id="single_table_info_holder_'.$table->id.'">';
    $tables_modal .= '<p class="table_name" class="ir_font_bold"><span>Table Name : </span><span id="sit_name_'.$table->id.'">'.$table->name.'<span></p>';
    ...
    $tables_modal .= '<button class="bottom_add pos_bg_base_transparent"  data-name="'.$table->name.'"  id="single_table_order_details_bottom_add_'.$table->id.'">Add</button>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
    $tables_modal .= '</div>';
}
                        ...
                        <?php if($is_self_order_class):
                            ...
                            <?php if($is_online_order=="Yes"):
                                ...
                                <li class="self_order_and_online_order online_order_after_login" style="display:<?php echo escape_output($online_login)?>">
                                    <a href="#" data-title="<?php echo lang('edit_profile'); ?>"  class="bg__blue irp_my_orders edit_customer"
                        ...
                        <li class="has__children <?php echo escape_output($is_self_order_class) ?>">
                            ...
                            <ul class="sub__menu" role="menu">
                                ...
                                <li class="<?=isset($language) && $language==$separete[1]?'active_lng':''?>"><a
                                       class="action_main_menu" data-url="<?php echo base_url(); ?>Authentication/setlanguagePOS/<?=escape_output($separete[1])?>" href="#"><?php echo escape_output(ucfirst($separete[1]))?></a>
                                </li>
                                <?php
                                endforeach;
                                ?>
        ...
        <div class="top_header_for_mobile <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
            <div class="for-table-mode <?php echo escape_output($is_self_order_class)?'self_order_mode':'' ?>">
                ...
                <div class="customer-add-edit">
                    <button data-title="<?php echo lang('edit_customer'); ?>"  data-tippy-content="<?php echo lang('edit_customer'); ?>"
            ...
            <div class="for-mobile-mode">
                ...
                <?php if($is_online_order=="Yes"):
                    ...
                    <button type="button" class="self_order_and_online_order online_order_after_login irp_my_orders edit_customer bg__green self_order_and_online_order_mobile" style="display:<?php echo escape_output($online_login)?>"> <span><?php echo lang('edit_profile'); ?></span></button>
                ...
                <div class="main_middle" style="<?php echo escape_output($is_self_order_class)?'width: 100%;':'' ?>">
                    ...
                    <div class="waiter_customer">
                        ...
                        <div class="separator <?php echo escape_output($is_self_order_class) ?>">
                                <a href="#"  data-title="<?php echo lang('edit_customer'); ?>" data-tippy-content="<?php echo lang('edit_customer'); ?>"
            ...
            <div>
                ...
                <li class="no-need-for-waiter">
                    <a href="#" class="last_ten_self_button">
                        <i class="fa fa-history"></i> <?php echo lang('self_online_orders'); ?></a>
                </li>
                <li class="no-need-for-waiter">
        ...
        <div class="modal-content" id="modal_content_show_tables2">
            ...
            <div class="select_table_modal_info_holder2 bg-c-gray">
                ...
                <div class="table-category-list bg-white pos_p_10">
                    ...
                    <ul class="dineIn-table-list-of-item">
                        <li>
                            <a href="javascript:void(0)" class="get_area_table" data-id="all"><?php echo lang('all'); ?></a>
                        </li>
                        <?php
                ...
                <div class="pos_w_100">
                    <div class="table_search_div pos_ml_10 bg-white pos_pt_10">
                        <input type="text" placeholder="<?php echo lang('search_table_place_holder'); ?>" id="table_search_input" class="table_search_input">
                    </div>
            ...
            <div class="bottom_button_holder_table_modal">
                ...
                <div class="right half">
                    <button class="floatright pos_btn_default" id="submit_table_modal"><?php echo lang('submit'); ?></button>
...
<div class="cus_pos_modal cus_pos_modal_self_online_sale_modal" id="customModalSelfOnlineOrder">
                ...
                <ul class="sub__menu__list">
                    ...
                    <li class="have_sub_sub_menu">
                        ...
                        <ul class="sub__sub__menu__list">
                            ...
                            <li  data-access="update-40" class="menu_assign_class"><a href="<?php echo base_url()?>setting/invoicePrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('invoice_printer_setting'); ?></a></li>
                            <li  data-access="update-43" class="menu_assign_class"><a href="<?php echo base_url()?>setting/billPrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('bill_printer_setting'); ?></a></li>
                            <li  data-access="update-46" class="menu_assign_class"><a href="<?php echo base_url()?>setting/KOTPrinterSetting">
                                    <i class="fa fa-angle-double-right"></i> <?php echo lang('kot_printer_setting'); ?></a></li>
                        </ul>
                    </li>
    ...
    <div class="kot_exist_checker"></div>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>frequent_changing/js/pos_script12123.js"></script>
