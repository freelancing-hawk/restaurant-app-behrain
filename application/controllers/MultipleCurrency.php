    ...
    public function addEditMultipleCurrency($encrypted_id = "") {
        ...
        if (htmlspecialchars($this->input->post('submit'))) {
            ...
            if ($this->form_validation->run() == TRUE) {
                $vat = array();
                $vat['currency'] = htmlspecialchars($this->input->post($this->security->xss_clean('currency')));
                $vat['conversion_rate'] = htmlspecialchars($this->input->post($this->security->xss_clean('conversion_rate')));
