    ...
    public function addPricingPlan($id='') {
        if ($this->input->post('submit')) {
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $data['price_for_month2'] = htmlspecialchars($this->input->post($this->security->xss_clean('price_for_month2')));
                ...
                $data['price_interval'] =htmlspecialchars($this->input->post($this->security->xss_clean('price_interval')));
