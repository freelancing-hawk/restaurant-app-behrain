...
class Promotion extends Cl_Controller {
    ...
    public function addEditPromotion($encrypted_id = "") {
        ...
        if ($this->input->post('submit')) {
            ...
            $type = htmlspecialchars($this->input->post($this->security->xss_clean('type')));
            if($type=="1"){
            ...
            if ($this->form_validation->run() == TRUE) {
                ...
                $promotion_info['title'] =htmlspecialchars($this->input->post($this->security->xss_clean('title')));
                ...
                $promotion_info['type'] =htmlspecialchars($this->input->post($this->security->xss_clean('type')));
                $food_menu_checking_id = '';
                if($type=="1"){
                    $promotion_info['food_menu_id'] =htmlspecialchars($this->input->post($this->security->xss_clean('food_menu_id')));
                    $promotion_info['discount'] =htmlspecialchars($this->input->post($this->security->xss_clean('discount')));
                    $food_menu_checking_id = $promotion_info['food_menu_id'];
                }else if($type==2){
                    $promotion_info['food_menu_id'] =htmlspecialchars($this->input->post($this->security->xss_clean('buy_food_menu_id')));
                    $promotion_info['qty'] =htmlspecialchars($this->input->post($this->security->xss_clean('qty')));
                    $promotion_info['get_food_menu_id'] =htmlspecialchars($this->input->post($this->security->xss_clean('get_food_menu_id')));
                    $promotion_info['get_qty'] =htmlspecialchars($this->input->post($this->security->xss_clean('get_qty')));
                    $promotion_info['status'] =htmlspecialchars($this->input->post($this->security->xss_clean('status')));
                    $food_menu_checking_id = $promotion_info['food_menu_id'];
                }
